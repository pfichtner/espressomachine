...
**Verdict: TeaVM is a viable frontend for EspressoMachine.**
...
For EspressoMachine's embedded target, standard library support will be replaced by intrinsics.
...
- Should the EspressoMachine backend implement `BranchingInstruction` by pattern-matching the immediately
